        ...
        <div>
            ...
            <div className='space-y-6'>
                { navItems.map((item, index) => {
                    return <Link key={index} href={item.href}  className='flex items-center text-highlight-light dark:text-highlight-dark text-xl font-semibold p-3 hover:scale-[0.98] transition'>
                        <item.icon size={24} />
