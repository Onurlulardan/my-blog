...
const commonClass =
  "border border-dashed border-secondary-dark dark:border-secondary-light flex items-center justify-center rounded cursor-pointer aspect-video text-secondary-dark dark:text-secondary-light";
