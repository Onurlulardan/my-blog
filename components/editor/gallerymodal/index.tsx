            ...
            <div className="flex ">
                ...
                <div className='basis-1/4 px-2'>
                    <div className='space-y-4'>
                        <div className=''>
                            <input onChange={(e) => {handleOnImageChange(e)}} hidden type="file" name='file' id="image-input" />
                        ...
                        {selectedImage ? <>
                            <textarea className='resize-none w-full bg-transparent  rounded border-2 border-secondary-dark focus:ring-1 text-primary dark:text-primary-dark h-32 p-1' placeholder='Alt Text'
                            value={altText}
